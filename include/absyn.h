...
typedef struct {S_symbol var; S_symbol typ; A_exp init; bool escape;} A_variableDec;

typedef enum {A_plusOp, A_minusOp, A_timesOp, A_divideOp,
	     A_eqOp, A_neqOp, A_ltOp, A_leOp, A_gtOp, A_geOp} A_oper;

typedef enum {A_varExp, A_nilExp, A_intExp, A_stringExp, A_callExp,
	A_opExp, A_recordExp, A_seqExp, A_assignExp, A_ifExp,
	A_whileExp, A_forExp, A_breakExp, A_letExp, A_arrayExp} A_expType;

typedef enum {A_simpleVar, A_fieldVar, A_subscriptVar} A_varType;

typedef enum {A_functionDec, A_varDec, A_typeDec} A_decType;

typedef enum {A_nameTy, A_recordTy, A_arrayTy} A_tyType;
